...
public class Floor{
    ...
    public Floor(){
        ...
        floorMap.add(new Room ("Ball pit", "The floor is balls. Everything is balls. Bright, multicolored balls. There are doors to the North, South, and West.", null, null, null, null));
